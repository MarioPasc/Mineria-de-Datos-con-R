...
wilcox.test(tam ~ recid, data = datos)
...
summary(aov(tam ~ grado, data = datos))
...
kruskal.test(tam ~ grado, data = datos)
...
Si no sigue una distribución normal se utiliza el **coeficiente de correlación de Spearman**. 
